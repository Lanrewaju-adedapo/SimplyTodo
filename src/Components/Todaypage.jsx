...
const Todaypage = ({
    ...
    try {
      ...
      if (response.status >= 200 && response.status < 300) {
        ...
        if (response.data?.success !== false) {
          ...
          // Refresh data if functions exist - with error handling
          try {
            ...
            // Don't show toast for refresh errors to avoid confusion
          }
        } else {
      ...
      // Optional: Revert local state on error if you want pessimistic updates
      // setTasks((prevTasks) =>
      //     prevTasks.map((task) =>
  ...
  const addNewTask = async () => {
    ...
    try {
      ...
      if (response.status >= 200 && response.status < 300) {
        ...
        // Add task to state - handle different response structures
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      {error === "Error fetching tasks:" && loader === false && (
